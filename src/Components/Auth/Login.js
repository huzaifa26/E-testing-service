      ...
      <div className="bg-white px-6 py-3 rounded-[10px] min-w-[300px] shadow-lg w-[21.216vw]">
        ...
        <form onSubmit={loginSubmitHandler} ref={loginData}>
          ...
          <div className="flex flex-col items-center justify-center my-3">
            ...
            <button onClick={() => { navigate('/signup') }} style={{ background: "white", color: "white", boxShadow: "0px 0px 0px rgba(0,0,0,0)" }} className="button !mb-[4.443vh] min-w-[150px] min-h-[30px] !my-1 !py-1 !text-[clamp(14px,0.801vw,32.82px)] !bg-white !border-2 !border-[#303035] !text-[#303035] !font-bold !uppercase">
              Signup
            </button>
          </div>
        </form>
