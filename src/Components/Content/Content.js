...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TablePagination, Paper, Tooltip, IconButton } from '@mui/material';
                ...
                <TableRow key={item.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  ...
                  <TableCell component="th" align='left'>
                    <Stack direction="row" spacing={0} sx={{ marginTop: '-15px' }}>
                      <Tooltip placement="top" arrow title="Download"><IconButton color="primary" aria-label="add to shopping cart"><ArrowDownwardIcon style={{ color: '#DC3535' }} onClick={() => saveFile(item)} /></IconButton></Tooltip>
                    </Stack>
                  </TableCell>
                </TableRow>
              ))}
