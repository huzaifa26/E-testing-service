      ...
      <nav className={sidebar ? 'nav-menu-active1' : 'nav-menu'}>
        <ul className="nav-menu-items">
          ...
          <li className="nav-text" title='Dashboard'>
            <Link  onClick={() => setTop(false)}  className={(location.pathname === "/dashboard" || location.pathname === '/dashboard/createCourse') && sidebar === false ? "flexstartborder" : sidebar === true && location.pathname === "/dashboard" ? "flexcenterborder": sidebar ===true ? "flexstart" : "flexcenter"} to={'/dashboard'}>
          ...
          <li className="nav-text" title='Notification'>
            <Link  onClick={() => setTop(false)} className={location.pathname === "/notification" && sidebar === false ? "flexstartborder" : sidebar === true && location.pathname === "/notification" ? "flexcenterborder": sidebar ===true ? "flexstart" : "flexcenter"} to={'/notification'}>
